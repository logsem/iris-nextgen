...
Definition clwp_def (c : C) (E : coPset) (e : expr) (Φ : val → iProp Σ) : iProp Σ :=
  (∀ K Ψ, (∀ v, Φ v -∗ WP fill K (of_val v) @ ↑c; E {{Ψ}})
            -∗ WP fill K e @ ↑c; E {{Ψ}})%I.
...
Section clwp.
  ...
  Lemma clwp_cl {c E e Φ} K :
    CLWP e @ ↑c; E {{Φ}} -∗
    (∀ Ψ, (∀ v, Φ v -∗ WP fill K (of_val v) @ ↑c; E {{Ψ}})
            -∗ WP fill K e @ ↑c; E {{Ψ}})%I.
  ...
  Lemma clwp_wand c E e Φ Ψ :
    CLWP e @ ↑c; E {{ Φ }} -∗ (∀ v, Φ v -∗ Ψ v) -∗ CLWP e @ ↑c; E {{ Ψ }}.
  Proof.
  ...
  Lemma clwp_wand_l c E e Φ Ψ :
    (∀ v, Φ v -∗ Ψ v) ∗ CLWP e @ ↑c; E {{ Φ }} ⊢ CLWP e @ ↑c; E {{ Ψ }}.
