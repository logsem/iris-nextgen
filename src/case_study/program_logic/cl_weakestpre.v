...
Section clwp_def.
  ...
  Context `{irisGS (CC_ectx_lang expr) Σ}.
...
Section clwp.
  ...
  Global Instance clwp_ne E e n :
    Proper (pointwise_relation _ (dist n) ==> dist n) (@clwp _ _ _ _ _ Λ Σ _ E e).
  Proof.
  ...
  Global Instance clwp_proper E e :
    Proper (pointwise_relation _ (≡) ==> (≡)) (@clwp _ _ _ _ _ Λ Σ _ E e).
  Proof.
